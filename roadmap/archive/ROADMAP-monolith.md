...
```
Phase 12 (Compliance & Audit) ✅
    └─> Phase 13.0 (Factor Contracts) — FactorValue, FactorScore, FactorConfig
            └─> 13.1 (Momentum Factors) — Price/volume/trend momentum
                    └─> 13.2 (Mean Reversion Factors) — Z-score, BB, RSI, half-life
                            └─> 13.3 (Carry & Volatility) — Realized/Parkinson vol, regime detection
                                    └─> 13.4 (Volume & Flow) — VWAP, order flow, price-volume correlation
                                            └─> 13.5 (ML Feature Pipeline) — Offline feature engineering
                                                    └─> 13.6 (Factor Scoring Strategy) — Multi-factor composite
                                                            └─> 13.7 (Stat Arb Strategy) — Pairs trading
                                                                    └─> 13.8 (Ensemble Meta) — Multi-strategy aggregation
                                                                            └─> 13.9 (Regime Adaptive) — Regime-switching logic
                                                                                    └─> 13.10 (Documentation) — Complete guides
```
...
## Phases 14-16 (Outline Only)

**Phase 14:** Simulation Harness (stress tests, Monte Carlo, multi-day replay)
**Phase 15:** Deployment Framework (systemd, Ansible, config packaging)
